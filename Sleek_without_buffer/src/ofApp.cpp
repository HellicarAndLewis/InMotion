...
void ofApp::setup(){
    ...
    gui.add(width1.set("width 1", 2, 0.5, ofGetWidth()));
    gui.add(width2.set("width 2", 2, 0.5, ofGetWidth()));
    gui.add(width3.set("width 3", 2, 0.5, ofGetWidth()));
    // sliders to specify the maximum width of the lines
    
    gui.add(height1.set("height 1", ofGetHeight(), 0.5, ofGetHeight()));
    gui.add(height2.set("height 2", ofGetHeight(), 0.5, ofGetHeight()));
    gui.add(height3.set("height 3", ofGetHeight(), 0.5, ofGetHeight()));
...
void ofApp::update(){
    ...
    if (sinewidth){
        lockwidth = false;
        float newwidth = ofMap(sin(ofGetElapsedTimef()), -1, 1, 0.5, ofGetWidth());
    ...
    if (sineheight){
        lockheight = false;
        float newheight = ofMap(sin(ofGetElapsedTimef()), -1, 1, 0.5, ofGetHeight());
